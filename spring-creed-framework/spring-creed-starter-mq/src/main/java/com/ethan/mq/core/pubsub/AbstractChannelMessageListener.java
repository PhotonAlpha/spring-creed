package com.ethan.mq.core.pubsub;
...
public abstract class AbstractChannelMessageListener<T extends AbstractChannelMessage> implements MessageListener {
    ...
    public final void onMessage(Message message, byte[] bytes) {
        T messageObj = (T) redisMQTemplate.getRedisTemplate().getValueSerializer().deserialize(message.getBody());
        // T messageObj = JacksonUtils.parseObject(message.getBody(), messageType);
        try {
