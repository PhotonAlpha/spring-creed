 ...
 * @date: 8/8/2022 12:11 PM
 */
public class CustomizeTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
        ...
        // alwaysCreateToken will create new token every time
        if (!this.alwaysCreateToken) {
        ...
        if (!StringUtils.equals("client_credentials", authentication.getOAuth2Request().getGrantType())) {
    ...
    protected OAuth2RefreshToken createRefreshToken(OAuth2Authentication authentication) {
        ...
        String value = EncryptUtils.enhanceTokenKey(UUID.randomUUID().toString());
    ...
    /**
     * this is enabled  to generate new token everytime
     * @param alwaysCreateToken
     */
