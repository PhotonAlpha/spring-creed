...
@Entity
@Table(name = "creed_system_user_authorities", indexes = {
        @Index(name = "CSUA_IDX_COMMON", columnList = "user_id,authority_id")
})
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(exclude = {"users", "authorities"})
@NoArgsConstructor
public class SystemUserAuthorities extends BaseDO {
    @Id
    ...
    public SystemUserAuthorities(SystemUsers users, SystemAuthorities authorities) {
        this.users = users;
