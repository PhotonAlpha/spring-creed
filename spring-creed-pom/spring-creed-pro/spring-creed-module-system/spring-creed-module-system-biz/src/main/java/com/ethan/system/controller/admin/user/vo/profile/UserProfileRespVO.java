...
public class UserProfileRespVO extends UserBaseVO {
    ...
    public static class Role {
        ...
        @Schema(name = "角色编号", required = true, example = "1")
        private Long id;

        @Schema(name = "角色名称", required = true, example = "普通角色")
        private String name;
    ...
    public static class Post {
        ...
        @Schema(name = "岗位编号", required = true, example = "1")
        private Long id;

        @Schema(name = "岗位名称", required = true, example = "开发")
        private String name;
    ...
    public static class SocialUser {
        ...
        @Schema(name = "社交平台的类型", required = true, example = "10", description = "参见 SocialTypeEnum 枚举类")
        private Integer type;

        @Schema(name = "社交用户的 openid", required = true, example = "IPRmJ0wvBptiPIlGEZiPewGwiEiE")
