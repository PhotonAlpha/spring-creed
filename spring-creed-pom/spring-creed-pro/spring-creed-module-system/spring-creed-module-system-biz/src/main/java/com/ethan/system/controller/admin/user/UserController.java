...
public class UserController {
    ...
    public R<Long> createUser(@Valid @RequestBody UserCreateReqVO reqVO) {
    ...
    @Schema(name = "删除用户")
    @Parameter(name = "id", value = "编号", required = true, example = "1024", dataTypeClass = Long.class)
    ...
    @Schema(name = value = "获取用户精简信息列表", description = "只包含被开启的用户，主要用于前端的下拉选项")
    ...
    @Schema(name = "导入用户")
    @Parameters({
            @Parameter(name = "file", value = "Excel 文件", required = true, dataTypeClass = MultipartFile.class),
            @Parameter(name = "updateSupport", value = "是否支持更新，默认为 false", example = "true", dataTypeClass = Boolean.class)
    })
