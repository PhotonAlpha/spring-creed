package com.ethan.system.dal.redis.core;

// import com.ethan.system.dal.entity.oauth2.OAuth2AccessTokenDO;

import java.time.Duration;

import static com.ethan.system.dal.redis.core.RedisKeyDefine.KeyTypeEnum.STRING;
...
public interface RedisKeyConstants {
    ...
    RedisKeyDefine OAUTH2_ACCESS_TOKEN = new RedisKeyDefine("访问令牌的缓存",
            "oauth2_access_token:%s", // 参数为访问令牌 token TODO
            STRING, String.class, RedisKeyDefine.TimeoutTypeEnum.DYNAMIC);
