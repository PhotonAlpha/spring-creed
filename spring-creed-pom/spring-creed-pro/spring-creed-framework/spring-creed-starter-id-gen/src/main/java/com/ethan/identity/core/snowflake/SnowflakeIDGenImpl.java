package com.ethan.identity.core.snowflake;

import com.ethan.identity.core.IDGen;
import com.ethan.identity.core.common.PropertyFactory;
import com.ethan.identity.core.common.Result;
import com.ethan.identity.core.common.Status;
import com.ethan.identity.core.common.Utils;
...
public class SnowflakeIDGenImpl implements IDGen {
    ...
    public SnowflakeIDGenImpl(String zkAddress, int port, long twepoch) {
        ...
        if (initFlag) {
            ...
            workerId = Long.parseLong(StringUtils.defaultString(PropertyFactory.getProperties().getProperty("leaf.snowflake.worker-id.default"), "1"));
            LOGGER.warn("START Failed, USE default WORKERID-{}", workerId);
        }
