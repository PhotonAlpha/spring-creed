...
public class ApiErrorLogBaseVO {
    ...
    @Schema(name = "请求地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "/xx/yy")
    @NotNull(message = "请求地址不能为空")
    private String requestUrl;

    @Schema(name = "请求参数", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(name = "异常发生时间", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常发生时间不能为空")
    @DateTimeFormat(pattern = DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND)
    private Date exceptionTime;

    @Schema(name = "异常名", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常名不能为空")
    private String exceptionName;

    @Schema(name = "异常导致的消息", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常导致的消息不能为空")
    private String exceptionMessage;

    @Schema(name = "异常导致的根消息", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常导致的根消息不能为空")
    private String exceptionRootCauseMessage;

    @Schema(name = "异常的栈轨迹", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常的栈轨迹不能为空")
    private String exceptionStackTrace;

    @Schema(name = "异常发生的类全名", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常发生的类全名不能为空")
    private String exceptionClassName;

    @Schema(name = "异常发生的类文件", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常发生的类文件不能为空")
    private String exceptionFileName;

    @Schema(name = "异常发生的方法名", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常发生的方法名不能为空")
    private String exceptionMethodName;

    @Schema(name = "异常发生的方法所在行", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "异常发生的方法所在行不能为空")
    private Integer exceptionLineNumber;

    @Schema(name = "处理状态", requiredMode = Schema.RequiredMode.REQUIRED, example = "0")
