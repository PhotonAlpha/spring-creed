...
package com.ethan.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.ethan.mq.core.RedisMQTemplate;
import com.ethan.mq.core.interceptor.RedisMessageInterceptor;
...
import com.ethan.redis.config.CreedRedisAutoConfiguration;
...
@Configuration
@AutoConfigureAfter(CreedRedisAutoConfiguration.class)
@Slf4j
public class RedisMQAutoConfiguration {
    ...
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> redisStreamMessageListenerContainer(
        ...
        StreamMessageListenerContainer<String, ObjectRecord<String, String>> container =
                ...
                /**
                 * 2023-03-16 14:57:45.984 ERROR [cTaskExecutor-2] ageListenerContainer$LoggingErrorHandler[341] : Unexpected error occurred in scheduled task
                 *
