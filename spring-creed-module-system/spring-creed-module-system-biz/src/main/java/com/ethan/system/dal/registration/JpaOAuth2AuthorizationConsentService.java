...
public class JpaOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    public JpaOAuth2AuthorizationConsentService(CreedOAuth2AuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
    ...
    private OAuth2AuthorizationConsent toObject(CreedOAuth2AuthorizationConsent authorizationConsent) {
    ...
    private CreedOAuth2AuthorizationConsent toEntity(OAuth2AuthorizationConsent authorizationConsent) {
        CreedOAuth2AuthorizationConsent entity = new CreedOAuth2AuthorizationConsent();
