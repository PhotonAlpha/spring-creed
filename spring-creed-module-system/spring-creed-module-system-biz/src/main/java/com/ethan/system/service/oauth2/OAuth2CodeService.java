...
public interface OAuth2CodeService {
     ...
     * @return 授权码的信息
     */
    CreedOAuth2Authorization createAuthorizationCode(Long userId, Integer userType, String clientId,
     ...
     * @param code 授权码
     */
    CreedOAuth2Authorization consumeAuthorizationCode(String code);
