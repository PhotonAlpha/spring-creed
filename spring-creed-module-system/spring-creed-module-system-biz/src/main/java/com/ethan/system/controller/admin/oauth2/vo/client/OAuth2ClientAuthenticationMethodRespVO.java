...
@Data
public class OAuth2ClientAuthenticationMethodRespVO {
    ...
    @Schema(description = "授权类型，参见 ClientAuthenticationMethod", requiredMode = Schema.RequiredMode.REQUIRED, example = "client_secret_basic")
