...
public interface MenuService {
     ...
     * @return 菜单列表
     */
    List<SystemMenus> getMenuListByTenant(MenuListReqVO reqVO);
     ...
     * @return 过滤后的菜单列表
     */
    List<SystemMenus> filterDisableMenus(List<SystemMenus> list);
     ...
     * @return 菜单列表
     */
    List<SystemMenus> getMenuList(MenuListReqVO reqVO);
     ...
     * @return 菜单
     */
    SystemMenus getMenuFromCache(Long id);
     ...
     * @return 菜单数组
     */
    List<SystemMenus> getMenuList(Collection<Long> ids);
}
