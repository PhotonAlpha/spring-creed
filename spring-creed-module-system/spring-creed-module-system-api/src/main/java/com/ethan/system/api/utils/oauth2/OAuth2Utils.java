package com.ethan.system.api.utils.oauth2;
...
public class OAuth2Utils {
    ...
    public static long getExpiresIn(Instant expireTime) {
        return (expireTime.toEpochMilli() - System.currentTimeMillis()) / 1000;
    }
